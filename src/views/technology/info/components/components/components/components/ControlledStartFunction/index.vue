<template>
  <div class="controlled-start-function">
    <plk-table
...
import ControlledStartFunctionPhase from './js/ControlledStartFunctionPhase'
export default {
  name: 'ControlledStartFunction',
  ...
  methods: {
    ...
    handleRadioChange(value) {
      ...
      const controlledStartFunctionPhase = new ControlledStartFunctionPhase(innerPhase)
      this.dispatch('PhaseStepDialog', 'on-functional-domain-data', controlledStartFunctionPhase)
    }
  }
}
</script>
