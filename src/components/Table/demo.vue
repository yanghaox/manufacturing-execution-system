<template>
  <div>
    <plkTable table-height="500" col-min-width="100px" :table-data="tableData" :table-header="tableHeader">
  ...
  data() {
    return {
      tableHeader: [
        ...
        { label: '操作', type: 'btn', minWidth: '200px', fixed: 'right' }
      ],
      tableData: [
        {
          id: 1,
